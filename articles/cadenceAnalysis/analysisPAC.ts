...
<br/>  
<img src="PASTEURLHERE/images/analyses/analyses-PAC-input-signal.png" alt="Input signal for PAC analysis" style="display: block; margin-inline: auto; height: 20rem" />
...
<br/>  
<img src="PASTEURLHERE/images/analyses/analyses-PAC-clock-generator.png" alt="Clock generator for PAC analysis" style="display: block; margin-inline: auto; height: 20rem" />
...
<br/>  
<img src="PASTEURLHERE/images/analyses/analyses-PSS-setup.png" alt="PSS analysis setup" style="display: block; margin-inline: auto; height: 80rem" />

### 4. PAC analysis setup
Fill in frequency range and the required frequency step. *Sidebands* should be 0.

<br/>  
<img src="PASTEURLHERE/images/analyses/analyses-PAC-setup.png" alt="PAC analysis setup" style="display: block; margin-inline: auto; height: 80rem" />

### 5. Printing out the results
Select *Results → Direct Plot → Main Form*. Then select *PAC* tab and select required parameters.

<br/>  
<img src="PASTEURLHERE/images/analyses/analyses-PAC-result.png" alt="PAC analysis result" style="display: block; margin-inline: auto; height: 40rem" />

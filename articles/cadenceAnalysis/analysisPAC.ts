...
<br/> <img src="http://localhost:3000/images/cadenceAnalysis/PAC-input-signal.png" alt="Input signal for PAC analysis" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/cadenceAnalysis/PAC-clock-generator.png" alt="Clock generator for PAC analysis" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/cadenceAnalysis/PAC-result.png" alt="PAC analysis result" style="display: block; margin-inline: auto; width: min(80%, 50rem)" /> 

...
2. [How to create a bus?](#createBus)
...
<br/> <img src="http://localhost:3000/images/cadenceTricks/multiple-bus-1.png" alt="Connecting multiple nets to the bus" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/cadenceTricks/multiple-bus-2.png" alt="Connecting multiple nets to the bus" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 

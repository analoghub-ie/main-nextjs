...
const article: TArticle = {
    id: 'layoutESD',
    title: 'Analog Layout Design Methodology. ESD.',
    description: 'This article describes analog layout design methodology and basic concepts',
    lastUpdate: new Date('2025-01-04'),
    hideInProd: true,
    content: `

## Analog Layout Methodology ESD

### Table of Contents
1. [Introduction](#introduction)
2. [Antenna effect](#)
3. [Secondary ESD protection](#)
4. [](#)

...
In the previous [article](/category/Layout/article/layoutMatchinghttps://analoghub.ie/category/Layout/article/layoutMatching) we spoke about matching and why it is important in analog layout. In this article we will dive deeper into matching patterns, such as interdigitation and common centroid and how to create your own matching pattern in layout. We will also discuss some practical aspects of matching.

|Subcircuit\t\t|Interdigitation|Common Centroid|
|---------------|---------------|---------------|
|Biasing circuit|✔\t\t\t\t|\t\t\t\t|
|Current mirror |✔\t\t\t\t|\t\t\t\t|
...
#### Abutted/separated:
**Abutted:** current mirrors (benefit of reduced Rds), biasing circuits
...
<br/> <img src="http://localhost:3000/images/layout/layoutCCStep1.svg" alt="Gradient types" style="display: block; margin-inline: auto; width: min(80%, 20rem)" /> 
<p style="display: block; text-align: center">Gradient types</p>  

<br/> <img src="http://localhost:3000/images/layout/layoutCCStep2.svg" alt="Gradient types" style="display: block; margin-inline: auto; width: min(80%, 20rem)" /> 
<p style="display: block; text-align: center">Gradient types</p>  

<br/> <img src="http://localhost:3000/images/layout/layoutCCStep3.svg" alt="Gradient types" style="display: block; margin-inline: auto; width: min(80%, 20rem)" /> 
<p style="display: block; text-align: center">Gradient types</p>  

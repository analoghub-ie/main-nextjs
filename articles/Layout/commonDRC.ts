...
<br/> <img src="http://localhost:3000/images/layout/nwSpacingDRC-1.png"  disableinvert alt="NWell spacing DRC error" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/layout/nwSpacingDRC-2.png"  disableinvert alt="NWell spacing DRC error [Solution]" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/layout/nwSpacingDRC-3.png"  disableinvert alt="NWell spacing DRC error [Solution]" style="display: block; margin-inline: auto; width: min(80%, 60rem)" /> 
<p style="display: block; text-align: center">NWell spacing DRC error [Solution]</p> 
...
<br/> <img src="http://localhost:3000/images/layout/ppSpacingDRC-1.png"  disableinvert alt="PP/NP spacing DRC error" style="display: block; margin-inline: auto; width: min(80%, 40rem)" /> 
...
<br/> <img src="http://localhost:3000/images/layout/ppSpacingDRC-2.png"  disableinvert alt="PP/NP spacing DRC error [Solution]" style="display: block; margin-inline: auto; width: min(80%, 60rem)" /> 
